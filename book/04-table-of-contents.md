...
## [Part 1 — Foundations of Architecture](part-01-foundations-of-architecture/README.md)

### [01 — What Is Software Architecture](part-01-foundations-of-architecture/01-what-is-software-architecture/README.md)
...
### [02 — Architectural Layers](part-01-foundations-of-architecture/02-architectural-layers/README.md)
...
### [03 — Architectural Boundaries](part-01-foundations-of-architecture/03-architectural-boundaries/README.md)
...
### [04 — Dependency Direction and Closed Architecture](part-01-foundations-of-architecture/04-dependency-direction-and-closed-architecture/README.md)
...
### [05 — Contracts and Interaction](part-01-foundations-of-architecture/05-contracts-and-interaction/README.md)
...
### [06 — Boundary Space](part-01-foundations-of-architecture/06-boundary-space/README.md)
- [What Boundary Space Is](part-01-foundations-of-architecture/06-boundary-space/01-what-boundary-space-is.md)
- [Execution vs Interaction](part-01-foundations-of-architecture/06-boundary-space/02-execution-vs-interaction.md)
- [Why Boundary Space Matters](part-01-foundations-of-architecture/06-boundary-space/03-why-boundary-space-matters.md)
- [Common Failure Modes](part-01-foundations-of-architecture/06-boundary-space/04-common-failure-modes.md)

### [07 — Architectural Units](part-01-foundations-of-architecture/07-architectural-units/README.md)
- [What Architectural Units Are](part-01-foundations-of-architecture/07-architectural-units/01-what-architectural-units-are.md)
- [Responsibility of Architectural Units](part-01-foundations-of-architecture/07-architectural-units/02-responsibility-of-architectural-units.md)
- [Why Architectural Units Matter](part-01-foundations-of-architecture/07-architectural-units/03-why-architectural-units-matter.md)
- [Common Failure Modes](part-01-foundations-of-architecture/07-architectural-units/04-common-failure-modes.md)

### [Part 1 Summary](part-01-foundations-of-architecture/part-01-summary/README.md)

---

## [Part 2 — Strutton Architecture](part-02-strutton-architecture/README.md)

### [01 — Architecture Overview](part-02-strutton-architecture/01-architecture-overview/README.md)
...
### [02 — Application Composition](part-02-strutton-architecture/02-application-composition/README.md)
...
### [03 — Request Entry and Coordinator Contracts](part-02-strutton-architecture/03-request-entry-and-coordinator-contracts/README.md)
...
### [04 — Coordinator Implementation](part-02-strutton-architecture/04-coordinator-implementation/README.md)
...
### [05 — Orchestration](part-02-strutton-architecture/05-orchestration/README.md)
...
### [06 — Repository and Persistence](part-02-strutton-architecture/06-repository-and-persistence/README.md)
...
### [07 — Transaction Model](part-02-strutton-architecture/07-transaction-model/README.md)
- [What a Transaction Is](part-02-strutton-architecture/07-transaction-model/01-what-a-transaction-is.md)
- [Single Transaction Flow](part-02-strutton-architecture/07-transaction-model/02-single-transaction-flow.md)
- [Multi-Transaction Workflow](part-02-strutton-architecture/07-transaction-model/03-multi-transaction-workflow.md)
- [Choosing the Right Approach](part-02-strutton-architecture/07-transaction-model/04-choosing-the-right-approach.md)
- [Common Failure Modes](part-02-strutton-architecture/07-transaction-model/05-common-failure-modes.md)

### [08 — DTOs, Entities, and Domain Visibility](part-02-strutton-architecture/08-dtos-entities-and-domain-visibility/README.md)
- [DTOs and Interaction](part-02-strutton-architecture/08-dtos-entities-and-domain-visibility/01-dtos-and-interaction.md)
- [Entities and Execution](part-02-strutton-architecture/08-dtos-entities-and-domain-visibility/02-entities-and-execution.md)
- [Domain Visibility Rules](part-02-strutton-architecture/08-dtos-entities-and-domain-visibility/03-domain-visibility-rules.md)
- [Why This Matters](part-02-strutton-architecture/08-dtos-entities-and-domain-visibility/04-why-this-matters.md)
- [Common Failure Modes](part-02-strutton-architecture/08-dtos-entities-and-domain-visibility/05-common-failure-modes.md)

### [09 — Presentation and Client Architecture](part-02-strutton-architecture/09-presentation-and-client-architecture/README.md)
- [API as System Boundary](part-02-strutton-architecture/09-presentation-and-client-architecture/01-api-as-system-boundary.md)
- [UI as Client](part-02-strutton-architecture/09-presentation-and-client-architecture/02-ui-as-client.md)
- [Supporting Multiple User Experiences](part-02-strutton-architecture/09-presentation-and-client-architecture/03-supporting-multiple-user-experiences.md)
- [Why This Matters](part-02-strutton-architecture/09-presentation-and-client-architecture/04-why-this-matters.md)

### [10 — Architectural Enforcement](part-02-strutton-architecture/10-architectural-enforcement/README.md)
- [How the Architecture Enforces Itself](part-02-strutton-architecture/10-architectural-enforcement/02-how-the-architecture-enforces-itself.md)
- [What This Prevents](part-02-strutton-architecture/10-architectural-enforcement/03-what-this-prevents.md)
- [Long-Term Impact](part-02-strutton-architecture/10-architectural-enforcement/04-long-term-impact.md)

### [Part 2 Summary](part-02-strutton-architecture/part-02-summary/README.md)

---

## [Part 3 — Architectural Application Styles](part-03-architectural-application-styles/README.md)

### [01 — Applying Architecture at Scale](part-03-architectural-application-styles/01-applying-architecture-at-scale/README.md)
...
### [02 — Clean Monolith](part-03-architectural-application-styles/02-clean-monolith/README.md)
...
### [03 — Service-Based Architecture](part-03-architectural-application-styles/03-service-based-architecture/README.md)
...
### [04 — Microservices](part-03-architectural-application-styles/04-microservices/README.md)
...
### [05 — What Changes and What Stays the Same](part-03-architectural-application-styles/05-what-changes-and-what-stays-the-same/README.md)
...
### [06 — Choosing the Right Style](part-03-architectural-application-styles/06-choosing-the-right-style/README.md)
...
### [Part 3 Summary](part-03-architectural-application-styles/part-03-summar/README.md)
